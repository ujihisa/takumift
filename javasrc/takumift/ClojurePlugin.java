...
public class ClojurePlugin extends JavaPlugin implements Listener {
    ...
    public void onPlayerRespawn(PlayerRespawnEvent event) {
        clojure.lang.Var f = clojure.lang.RT.var("takumift.core", "player-respawn-event");
        if (f.isBound()) f.invoke(event);
    }
    @EventHandler
    ...
    public void onProjectileLaunchEvent(ProjectileLaunchEvent event) {
        clojure.lang.Var f = clojure.lang.RT.var("takumift.core", "projectile-launch-event");
        if (f.isBound()) f.invoke(event);
    }
    @EventHandler
    public void onCreatureSpawnEvent(CreatureSpawnEvent event) {
        clojure.lang.Var f = clojure.lang.RT.var("takumift.core", "creature-spawn-event");
        if (f.isBound()) f.invoke(event);
    }
    @EventHandler
    public void onFoodLevelChange(FoodLevelChangeEvent event) {
        clojure.lang.Var f = clojure.lang.RT.var("takumift.core", "food-level-change-event");
        if (f.isBound()) f.invoke(event);
    }
    @EventHandler
    public void onEntityCombust(EntityCombustEvent event) {
        clojure.lang.Var f = clojure.lang.RT.var("takumift.core", "entity-combust-event");
        if (f.isBound()) f.invoke(event);
    }
    @EventHandler
    ...
    */
    ...
    public void onVehicleBlockCollision(VehicleBlockCollisionEvent event) {
        clojure.lang.Var f = clojure.lang.RT.var("takumift.core", "vehicle-block-collision-event");
        if (f.isBound()) f.invoke(event);
    }
    /*
    @EventHandler
    public void onVehicleCreate(VehicleCreateEvent event) {
        clojure.lang.Var f = clojure.lang.RT.var("takumift.core", "vehicle-create-event");
        if (f.isBound()) f.invoke(event);
    }
    */
    @EventHandler
    public void onVehicleDamage(VehicleDamageEvent event) {
        clojure.lang.Var f = clojure.lang.RT.var("takumift.core", "vehicle-damage-event");
        if (f.isBound()) f.invoke(event);
    }
    @EventHandler
    public void onVehicleDestroy(VehicleDestroyEvent event) {
        clojure.lang.Var f = clojure.lang.RT.var("takumift.core", "vehicle-destroy-event");
        if (f.isBound()) f.invoke(event);
    }
    @EventHandler
    public void onVehicleEnter(VehicleEnterEvent event) {
        clojure.lang.Var f = clojure.lang.RT.var("takumift.core", "vehicle-enter-event");
        if (f.isBound()) f.invoke(event);
    }
    @EventHandler
    public void onVehicleEntityCollision(VehicleEntityCollisionEvent event) {
        clojure.lang.Var f = clojure.lang.RT.var("takumift.core", "vehicle-entity-collision-event");
        if (f.isBound()) f.invoke(event);
    }
    @EventHandler
    public void onVehicleExit(VehicleExitEvent event) {
        clojure.lang.Var f = clojure.lang.RT.var("takumift.core", "vehicle-exit-event");
        if (f.isBound()) f.invoke(event);
    }
    @EventHandler
    public void onVehicleMove(VehicleMoveEvent event) {
        clojure.lang.Var f = clojure.lang.RT.var("takumift.core", "vehicle-move-event");
        if (f.isBound()) f.invoke(event);
    }
    @EventHandler
    public void onVehicleUpdate(VehicleUpdateEvent event) {
        clojure.lang.Var f = clojure.lang.RT.var("takumift.core", "vehicle-update-event");
        if (f.isBound()) f.invoke(event);
    }
    @EventHandler
    public void onChunkPopulate(ChunkPopulateEvent event) {
        clojure.lang.Var f = clojure.lang.RT.var("takumift.core", "chunk-populate-event");
        if (f.isBound()) f.invoke(event);
    }
    @EventHandler
    public void onPaintingBreakByEntity(PaintingBreakByEntityEvent event) {
        clojure.lang.Var f = clojure.lang.RT.var("takumift.core", "painting-break-by-entity-event");
        if (f.isBound()) f.invoke(event);
    }
